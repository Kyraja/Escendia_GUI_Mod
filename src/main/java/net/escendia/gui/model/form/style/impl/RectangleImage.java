...
public class RectangleImage extends Rectangle {
    ...
    private transient final double borderTopPositions[][] = new double[4][2];
    private transient final double borderBottomPositions[][] = new double[4][2];
    private transient final double borderRightPositions[][] = new double[4][2];
    private transient final double borderLeftPositions[][] = new double[4][2];
    ...
    public void draw() {
        ...
        Image image = style.getBackgroundImage();
        ...
        if(image != null && image.getTexture() != null) {
            ...
            drawUtils.drawTexture(style.getBackgroundImage().getTexture(),
                    style.getXPosition() - padding.getPaddingByType(PaddingType.LEFT),
